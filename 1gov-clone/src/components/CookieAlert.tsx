...
const CookieAlert = () => {
    ...
    return (
        <>
        {showAlert && 
            <div className="fixed bottom-0 bg-white h-100 mb-5 mr-8 ml-8 shadow-2xl text-center pl-18 pr-18 lg:flex lg:h-70 lg:text-left lg:pl-12 lg:w-240 lg:ml-65 ">
                <div className="">
                ...
                <div className="flex gap-8 justify-center mt-10 lg:justify-start lg:mt-35">
                    <div>
                    ...
                    <div>
                        <button onClick={() => (setShowAlert(false))} className="text-[#035E35] underline text-[18px] mt-3">Reject</button>
                    </div>
                </div>
            </div>}
